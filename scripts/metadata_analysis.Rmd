...
proteins <- dplyr::filter(metadata, !is.na(n_proteins)) %>%
  ...
  theme(
        ...
        axis.ticks.x = element_blank()) +
  scale_colour_manual(values = clade_colors) + 
  ggsave('plots/protein_coding_gene_N_boxplot_tiny.pdf', width = 2.5, height = 2)
proteins
...
```{r}
plot_grid(genome_size, as_len, mrna_length, total_cds, mean_mrnas, number_introns, intron_length, legend, labels = 'AUTO', label_size = 14,
          nrow = 4, ncol = 2) + 
  ggsave2(filename = 'plots/supplementary_fig1.pdf', height = 10, width = 10)
plot_grid(genome_size, as_len, mrna_length, total_cds, mean_mrnas, number_introns, intron_length, legend, labels = 'AUTO', label_size = 14,
          nrow = 4, ncol = 2) + 
  ggsave2(filename = 'plots/supplementary_fig1.png', height = 10, width = 10)
```

```{r}

stats_interest <- c('Total_mrna_length', "Total_cds_length", 'Number_of_intron_in_cds', 'Number_of_intron_in_cds', "Total_intron_length_per_cds", 'mean_mrna_length')
